...
class Coach {
    ...
    static async getAvailability(id) {
        try {
            ...
            try {
                [availabilityRows] = await pool.query(
                    `SELECT 
                        id,
                        day_of_week,
                ...
                console.log('⚠️ Error fetching coach availability:', error.message);
            }

            // Get booked appointments
let appointmentRows = [];
            try {
                [appointmentRows] = await pool.query(
                    `SELECT 
                        id,
                ...
                console.log('⚠️ Error fetching appointments:', error.message);
            }

            // Default working hours
            const workingHours = '08:00-22:00';
        ...
        try {
            ...
            const [rows] = await pool.query(
                `SELECT 
                    ...
                    COALESCE(u.avatar_url, u.profile_image) as user_avatar
                FROM feedback f
