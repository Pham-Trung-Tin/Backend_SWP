...
const createAppointmentsStatusRoutes = () => {
  const router = express.Router();
  
  /**
   * @route POST /api/appointments-update/:id/status
  ...
  /**
   * @route OPTIONS /api/appointments-update/:id/status
...
export default createAppointmentsStatusRoutes;
